...
CEOP
      ...
      COMMON /PP81_PARMS_I/  
     &     PPnRi
      Real*8    PPviscMin, PPdiffMin, PPviscMax
      Real*8    PPnu0, PPalpha, RiLimit
      Real*8    PPdumpFreq, PPtaveFreq
      COMMON /PP81_PARMS_R/     
     &     PPviscMin, PPdiffMin, PPviscMax, 
     &     PPnu0, PPalpha, RiLimit,
     &     PPdumpFreq, PPtaveFreq

      Real*8 PPviscAr (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 PPdiffKr (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
