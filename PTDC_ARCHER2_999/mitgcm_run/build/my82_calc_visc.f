...
CEOP
     ...
     &         KappaRU(i,j,k) - viscArNr(k) + maskW(i,j,k,bi,bj) *
     &    0.5D0*(MYviscAr(i,j,k,bi,bj)+MYviscAr(i-1,j,k,bi,bj)) )
       ENDDO
      ENDDO
     ...
     &         KappaRV(i,j,k) - viscArNr(k) + maskS(i,j,k,bi,bj) *
     &    0.5D0*(MYviscAr(i,j,k,bi,bj)+MYviscAr(i,j-1,k,bi,bj)) )
       ENDDO
      ENDDO
