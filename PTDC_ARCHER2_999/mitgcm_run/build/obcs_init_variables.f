      ...
      DO bj = myByLo(myThid), myByHi(myThid)
       DO bi = myBxLo(myThid), myBxHi(myThid)
        ...
        DO i=1-Olx,sNx+Olx
          OBNeta (i,bi,bj) = 0.D0
          OBSeta (i,bi,bj) = 0.D0
          OBNeta0(i,bi,bj) = 0.D0
          OBSeta0(i,bi,bj) = 0.D0
          OBNeta1(i,bi,bj) = 0.D0
          OBSeta1(i,bi,bj) = 0.D0
        ENDDO
        DO j=1-Oly,sNy+Oly
          OBEeta (j,bi,bj) = 0.D0
          OBWeta (j,bi,bj) = 0.D0
          OBEeta0(j,bi,bj) = 0.D0
          OBWeta0(j,bi,bj) = 0.D0
          OBEeta1(j,bi,bj) = 0.D0
          OBWeta1(j,bi,bj) = 0.D0
        ENDDO
