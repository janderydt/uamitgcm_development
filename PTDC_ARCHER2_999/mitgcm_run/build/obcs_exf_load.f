...
C     etc
     ...
     &  OBNeta,  OBSeta,  OBEeta,  OBWeta
      Real*8 OBNeta (1-Olx:sNx+Olx,nSx,nSy)
      Real*8 OBSeta (1-Olx:sNx+Olx,nSx,nSy)
      Real*8 OBEeta (1-Oly:sNy+Oly,nSx,nSy)
      Real*8 OBWeta (1-Oly:sNy+Oly,nSx,nSy)
      COMMON /OBCS_NLFS_FIELDS_AUX/
     &      OBNeta0,OBSeta0,OBEeta0,OBWeta0,
     &      OBNeta1,OBSeta1,OBEeta1,OBWeta1
      Real*8 OBNeta0(1-Olx:sNx+Olx,nSx,nSy)
      Real*8 OBSeta0(1-Olx:sNx+Olx,nSx,nSy)
      Real*8 OBEeta0(1-Oly:sNy+Oly,nSx,nSy)
      Real*8 OBWeta0(1-Oly:sNy+Oly,nSx,nSy)
      Real*8 OBNeta1(1-Olx:sNx+Olx,nSx,nSy)
      Real*8 OBSeta1(1-Olx:sNx+Olx,nSx,nSy)
      Real*8 OBEeta1(1-Oly:sNy+Oly,nSx,nSy)
      Real*8 OBWeta1(1-Oly:sNy+Oly,nSx,nSy)
...
C     !INPUT/OUTPUT PARAMETERS:
      ...
      Real*8 OBeta   (1-OLx:sNx+OLx,nSx,nSy)
      Real*8 OBeta0  (1-OLx:sNx+OLx,nSx,nSy)
      Real*8 OBeta1  (1-OLx:sNx+OLx,nSx,nSy)
...
CEOP
      ...
      IF ( useCAL .AND. obcsPeriod .EQ. -12.D0 ) THEN
...
C     records, corresponding to Jan. (rec=1) through Dec. (rec=12)
     ...
     O              count0, count1,
     I              myTime, myIter, myThid )
      ELSEIF ( obcsPeriod .LT. 0.D0 ) THEN
...
C     !INPUT/OUTPUT PARAMETERS:
      ...
      CHARACTER*(MAX_LEN_FNAM) OBuFile,OBvFile,OBtFile,OBsFile
      Real*8 OBeta   (1-OLy:sNy+OLy,nSx,nSy)
      Real*8 OBeta0  (1-OLy:sNy+OLy,nSx,nSy)
      Real*8 OBeta1  (1-OLy:sNy+OLy,nSx,nSy)
      CHARACTER*(MAX_LEN_FNAM) OBetaFile
      Real*8     myTime
      INTEGER myIter
      INTEGER myThid
